...
public class StickHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickHeaderDecoration(Context context) {
        ...
        mTextPaddingRight = dp2px(context,45);
        ...
        mTextPaint.setTextSize(dp2px(context,15));
        ...
        if (parent.getAdapter() instanceof RecyclerViewAdapter) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (isHeader) {
                    ...
                    c.drawText("结余", right-mTextPaddingRight, (view.getTop() - mItemHeaderHeight) + mItemHeaderHeight / 2 + mTextRect.height() / 2, mTextPaint);
                } else {
