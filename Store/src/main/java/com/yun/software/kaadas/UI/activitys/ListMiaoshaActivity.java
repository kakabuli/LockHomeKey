...
import com.yun.software.kaadas.UI.adapter.ListZhongchouAdapter;
 ...
 * on 2019/3/15
 */
public class ListMiaoshaActivity extends BaseActivity {
    ...
    ListMiaoshaAdapter listAdapter;
    ...
    protected void initViewsAndEvents() {
        ...
        listAdapter=new ListMiaoshaAdapter(listBeans);
...
//        recyclerView.setLayoutManager(new GridLayoutManager(mContext, 2));
        ...
        listAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                bundle.putInt("type",ShopDetailsNewActivity.TYPE_MIAOSHA);
...
//
    ...
    private void getData() {
        ...
        params.put("type","product_type_seckill");
