 ...
 * on 2019/3/15
 */
public class ListZhongchouActivity extends BaseActivity {
    ...
    ListZhongchouAdapter listAdapter;
    ...
    protected void initViewsAndEvents() {
        tvTitle.setText("今日众筹");

        listAdapter=new ListZhongchouAdapter(listBeans);
...
//        recyclerView.setLayoutManager(new GridLayoutManager(mContext, 2));
        ...
        listAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                bundle.putInt("type",ShopDetailsNewActivity.TYPE_ZHONGCHOU);
...
//
    ...
    private void getData() {
        ...
        params.put("type","product_type_crowd");
