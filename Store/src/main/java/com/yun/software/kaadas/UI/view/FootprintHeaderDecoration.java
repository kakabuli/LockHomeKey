...
import com.yun.software.kaadas.UI.adapter.RecyclerViewAdapter;
 ...
 */
public class FootprintHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public FootprintHeaderDecoration(Context context) {
        mItemHeaderHeight = dp2px(context, 40);
        mTextPaddingLeft = dp2px(context, 15);

        mTextRect = new Rect();

        mItemHeaderPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mItemHeaderPaint.setColor(Color.parseColor("#F8F8F8"));
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        if (parent.getAdapter() instanceof FootprintAdapter) {
            FootprintAdapter adapter = (FootprintAdapter) parent.getAdapter();
