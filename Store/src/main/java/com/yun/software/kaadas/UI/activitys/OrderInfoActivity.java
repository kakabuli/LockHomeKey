...
import com.yun.software.kaadas.UI.adapter.OrderInfoAdapter;
...
public class OrderInfoActivity extends BaseActivity {
    ...
    protected void initViewsAndEvents() {
        tvTitle.setText("订单消息");


        listAdapter=new OrderInfoAdapter(listBeans);
...
//
    ...
    private void getData() {
        ...
        params.put("messageType","message_type_indent");
        map.put("params",params);
        Map<String,Object> page = new HashMap<>();
        page.put("pageNum",String.valueOf(startIndex));
        page.put("pageSize",String.valueOf(pageSize));
        map.put("page",page);
        HttpManager.getInstance().post(mContext, ApiConstants.SYSMESSAGE_GETSYSMESSAGELISTBYTYPE, map, new OnIResponseListener() {
            @Override
