...
import com.yun.software.kaadas.UI.adapter.ActInfoAdapter;
...
public class ActInfoActivity extends BaseActivity {
    ...
    protected void initViewsAndEvents() {
        ...
        listAdapter=new ActInfoAdapter(listBeans);
...
//
    ...
    private void getData() {
        ...
        params.put("messageType","message_type_activity");
