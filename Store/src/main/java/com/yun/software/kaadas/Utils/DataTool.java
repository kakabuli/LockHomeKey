...
import static com.yun.software.kaadas.Utils.ConstTool.BYTE;
import static com.yun.software.kaadas.Utils.ConstTool.GB;
import static com.yun.software.kaadas.Utils.ConstTool.KB;
import static com.yun.software.kaadas.Utils.ConstTool.MB;
...
public class DataTool {
    ...
    public static String changeDistance(double length, boolean displayMeter) {
        if (length < 1000) {
            return ConstTool.FORMAT_TWO.format(length) + (displayMeter ? "米" : "");
        } else {
            return ConstTool.FORMAT_TWO.format(length / 1000) + (displayMeter ? "千米" : "");
        }
    }

    /**
     * outputStream转ByteArrayInputStream
     *
     * @param out 输出流
