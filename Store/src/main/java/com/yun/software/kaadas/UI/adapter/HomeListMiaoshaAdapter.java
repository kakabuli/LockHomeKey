...
public class HomeListMiaoshaAdapter extends BaseQuickAdapter<GoodsBean,BaseViewHolder> {


    private List<GoodsBean> datas ;
    public HomeListMiaoshaAdapter(List<GoodsBean> datas) {
    ...
    protected void convert(BaseViewHolder helper, GoodsBean item) {
        ...
        tvOldPriveView.getPaint().setFlags(Paint.STRIKE_THRU_TEXT_FLAG|Paint.ANTI_ALIAS_FLAG); //中划线
