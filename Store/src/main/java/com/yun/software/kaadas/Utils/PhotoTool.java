...
import static com.yun.software.kaadas.Utils.FileTool.getDataColumn;
import static com.yun.software.kaadas.Utils.FileTool.isDownloadsDocument;
import static com.yun.software.kaadas.Utils.FileTool.isExternalStorageDocument;
import static com.yun.software.kaadas.Utils.FileTool.isGooglePhotosUri;
import static com.yun.software.kaadas.Utils.FileTool.isMediaDocument;
...
public class PhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ToastUtil.showShort("请先获取写入SDCard权限");
        } else {
