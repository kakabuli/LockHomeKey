...
public class ApplyDrawBackActivity extends BaseActivity {
    ...
    protected void initViewsAndEvents() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (i == R.id.view_iamge) {
                    ...
                    if (pictures.get(position).getPath().equals("temp")) {
                        ...
                        BigImageActivity.startImagePagerActivity(ApplyDrawBackActivity.this, strings, 0);
                    }
        ...
        reChoiceSaReson.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void uploadFile(FeedPicture feedPicture) {
        IProgressDialog dialog = new IProgressDialog() {
            ...
            public Dialog getDialog() {
                ProgressDialog dialog = new ProgressDialog(ApplyDrawBackActivity.this);
    ...
    private void submitReson() {
        ...
        String str_price = tvPrice.getText().toString();
        ...
        params.put("type","returnbill_type_stauts_refund");
...
//                setView();
    ...
    private void getHotData() {
        ...
        HttpManager.getInstance().post(mContext, ApiConstants.COMMONAPP_GETALLKEYVALUE, map, new OnIResponseListener() {
            @Override
            public void onSucceed(String result) {
                String keyjson = StringUtil.getJsonKeyStr(result, "after_sales_service");
                Gson gson = new Gson();
                List<HotkeyBean> list = gson.fromJson(keyjson, new TypeToken<List<HotkeyBean>>() {
                }.getType());
