...
import com.yun.software.kaadas.UI.adapter.ListMiaoshaAdapter;
import com.yun.software.kaadas.UI.adapter.ListPintuanAdapter;
 ...
 * on 2019/3/15
 */
public class ListPintuanActivity extends BaseActivity {
    ...
    ListPintuanAdapter listAdapter;
    ...
    protected void initViewsAndEvents() {
        tvTitle.setText("今日拼团");

        listAdapter=new ListPintuanAdapter(listBeans);
...
//        recyclerView.setLayoutManager(new GridLayoutManager(mContext, 2));
        ...
        listAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                bundle.putInt("type",ShopDetailsNewActivity.TYPE_PINTUAN);
    ...
    private void getData() {
        ...
        params.put("type","product_type_group");
