...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(com.bigkoo.pickerview.R.dimen.pickerview_textsize);//默认大小
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.bigkoo.pickerview.R.styleable.pickerview, 0, 0);
            mGravity = a.getInt(com.bigkoo.pickerview.R.styleable.pickerview_pickerview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(com.bigkoo.pickerview.R.styleable.pickerview_pickerview_textColorOut, textColorOut);
            textColorCenter = a.getColor(com.bigkoo.pickerview.R.styleable.pickerview_pickerview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(com.bigkoo.pickerview.R.styleable.pickerview_pickerview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(com.bigkoo.pickerview.R.styleable.pickerview_pickerview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(com.bigkoo.pickerview.R.styleable.pickerview_pickerview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
