...
public class CommonDialog extends Dialog implements View.OnClickListener {
    ...
    private LinearLayout mlinbottmo;
    private Button mConfirmBtn;
    private Button mCancelBtn;
    private int mCancleColor=-1;
    ...
    private void init() {
        ...
        mlinbottmo = (LinearLayout) findViewById(R.id.lin_bottom);
        ...
        if(StringUtil.isEmpty(mTitle)){
            ...
            paddins=SizeUtils.dp2px(20);
        }else{
            paddins=SizeUtils.dp2px(6);
            mTitleView.setVisibility(View.VISIBLE);
            mTitleView.setText(mTitle);
        }
        if(!mshowBottom){
            mlinbottmo.setVisibility(View.GONE);
        }
        if(mCancleColor!=-1){
            mCancelBtn.setTextColor(getContext().getResources().getColor(mCancleColor));
        }
        if(mOkColor!=-1){
            mConfirmBtn.setTextColor(getContext().getResources().getColor(mOkColor));
        }
        mInfoView.setPadding(0,paddins, 0,SizeUtils.dp2px(20));
    ...
    public static class Builder {
        ...
        public Builder setCancleColor(int color){
            this.cancleColor=color;
            return this;
        }
        public Builder setOkColor(int color){
            this.okColor=color;
            return this;
        }
        ...
        public CommonDialog create() {
            ...
            dialog.setValue(this.mTitle, this.mInfoText, this.mConfirmText, this.mCancelText, this.mDoNotShowAgain, mDialogCallback,this.okColor,this.cancleColor,showbottom);
