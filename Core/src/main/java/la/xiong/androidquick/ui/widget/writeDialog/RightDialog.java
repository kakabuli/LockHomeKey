...
public class RightDialog extends BaseDialog {
    ...
    public static RightDialog create(FragmentManager mFragmentManager){
        RightDialog commentDialog=new RightDialog();
    ...
    public RightDialog setFragmentManager(FragmentManager manager) {
        mFragmentManager = manager;
        return this;
    }

    public RightDialog setViewListener(ViewListener listener) {
        mViewListener = listener;
        return this;
    }

    public RightDialog setLayoutRes(@LayoutRes int layoutRes) {
        mLayoutRes = layoutRes;
        return this;
    }

    public RightDialog setCancelOutside(boolean cancel) {
        mIsCancelOutside = cancel;
        return this;
    }

    public RightDialog setTag(String tag) {
        TAG = tag;
        return this;
    }

    public RightDialog setDimAmount(float dim) {
        mDimAmount = dim;
        return this;
    }

    public RightDialog setCutDownTime(long time) {
        mCutDown = time/1000;
        return this;
    }
