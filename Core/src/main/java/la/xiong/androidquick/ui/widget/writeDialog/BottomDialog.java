...
public class BottomDialog extends BaseDialog {
    ...
    public static BottomDialog create(FragmentManager mFragmentManager){
        BottomDialog commentDialog=new BottomDialog();
    ...
    public BottomDialog setCutDownTime(long time) {
        mCutDown = time/1000;
        return this;
    }
