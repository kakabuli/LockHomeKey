package la.xiong.androidquick.ui.widget;
    ...
    public void setLoadingTip(LoadStatus loadStatus){
        switch (loadStatus){
            case empty:
                ...
                img_tip_logo.setImageResource(R.drawable.icon_loading_empty3x);
                break;
            case sereverError:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
                ...
                img_tip_logo.setImageResource(R.drawable.ic_error);
                break;
            case error:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
                progress.setVisibility(View.GONE);
                if (TextUtils.isEmpty(errorMsg)){
                    tv_tips.setText("暂无网络");
                }else {
                    tv_tips.setText(errorMsg);
                }
                bt_operate.setVisibility(VISIBLE);
                img_tip_logo.setImageResource(R.drawable.ic_exception);
                break;
            case loading:
                setVisibility(View.VISIBLE);
                bt_operate.setVisibility(GONE);
