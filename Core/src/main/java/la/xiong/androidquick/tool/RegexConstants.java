...
//    public static final String REGEX_ID_CARD15     = "^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$";
    public static final String REGEX_ID_CARD15     = "^[1-9]\\d{14}";
//    public static final String REGEX_ID_BANDCARDS     = "^\\d{12}";
    public static final String REGEX_ID_BANDCARDS     = "^\\d{16}";
    public static final String REGEX_ID_EXPIREDATE     = "[0|1]\\d\\/\\d{4}";
    public static final String REGEX_ID_DATA     = "^d[0|1|2]\\d{2}";
    /**
     ...
     * <p>length is between 8 to 20</p>
     */
    public static final String REGEX_USERNAME      = "^[\\w\\u4e00-\\u9fa5]{8,20}(?<!_)$";
    /**
     ...
     * 正则：URL
     */
    public static final String REGEX_URL_TWO = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w-./?%&=]*)?";
    /**
     * 正则：汉字
     */
