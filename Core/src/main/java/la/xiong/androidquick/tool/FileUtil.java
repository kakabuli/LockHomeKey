...
public class FileUtil {
    ...
    public static final String IMAGESAVEPATH = "";
    ...
    public static String getSaveImagePath(Context context){
        ...
        return new File(cacheDir.getPath() + File.separator + "KADDAS").getAbsolutePath();
...
//    }
    ...
    public static boolean moveFileboolean(File srcFile, File destFile) {
