...
import static com.yun.store.util.FileTool.isDownloadsDocument;
import static com.yun.store.util.FileTool.isExternalStorageDocument;
import static com.yun.store.util.FileTool.isGooglePhotosUri;
import static com.yun.store.util.FileTool.isMediaDocument;
...
public class PhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            SimpleDateFormat timeFormatter = new SimpleDateFormat("yyyyMMdd_HHmmss", java.util.Locale.CHINA);
