...
class LinphoneCoreImpl implements LinphoneCore {
	...
	private native int getTransportPort(long nativePtr, int code);
...
//	暂停当前的通话。
	...
	public synchronized int getSipTransportPort() {
		return getTransportPort(nativePtr,0);
	}
...
//	把当前的通话转接到另一个正在进行的通话当中。
	...
	private native void setDeviceIp(long nativePtr, String path);
	...
	@Override
	public synchronized void setDeviceIp(String path) {
		setDeviceIp(nativePtr, path);
	}
