 ...
 *LinphoneCore是整个linphone内核基于JNI的封装接口，LinphoneCoreImpl是linphone内核针对JAVA开发语言的封装。所有linphone内核的相关方法都是通过它来向android系统暴露
 */
...
public interface LinphoneCore {
	...
	static public class FirewallPolicy {
		...
		public FirewallPolicy(int value, String stringValue) {
			mValue = value;
			values.addElement(this);
			mStringValue=stringValue;
		}
	...
	*/
	...
	public  int getSipTransportPort();
	/**
	...
	**/
	 ...
	 *             设置播放给对方听的音乐，通话还在呼入的状态下。
	 */
	void setPlayFile(String path);
	void setDeviceIp(String path);
