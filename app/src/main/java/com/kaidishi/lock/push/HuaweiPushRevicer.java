...
//        void onNetEventToken(String token);
//    }
...
//        }
        ...
        if(!TextUtils.isEmpty(tokenIn)){
            ...
            evevt.onNetEventToken(tokenIn);
            Log.e(GeTui.VideoLog,"HuaweiPushRevicer==>tokenIn生成成功:"+tokenIn);
        }
