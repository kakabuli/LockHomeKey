...
public class BleLockUtils {
    ...
    static {
        ...
        FUNCTION_SET.put(0x7B, new Integer[]{1, 2, 3, 4, 5, 6, 7, 8, 10, 13, 14, 15, 16, 17, 19, 20, 21, 22, 23, 32, 33, 34, 37, 38, 47, 51, 52, 53, 55, 57, 58, 59, 68, 69, 70, 71, 72, 73, 74, 75, 76, 93});
