...
/**
 * Create By denganzhi  on 2019/2/22
 * Describe
 */
...
public class GeTui {
	...
	public static final String FTP_IMAGE_FAIL= Constants.IMAGE+"FAIL";
	public static final String FTP_IMAGE_SUC= Constants.IMAGE+"SUCCESS";
	public static final String FTP_VIDEO_FAIL= Constants.VIDEO+"FAIL";
	public static final String FTP_AUDIO_FAIL= Constants.AUDIO+"FAIL";
	public static final String FTP_IMAGE_COPY= Constants.IMAGE+"COPY";
