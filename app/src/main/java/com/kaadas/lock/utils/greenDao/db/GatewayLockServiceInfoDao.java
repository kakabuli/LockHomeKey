...
/** 
 * DAO for table "GATEWAY_LOCK_SERVICE_INFO".
*/
public class GatewayLockServiceInfoDao extends AbstractDao<GatewayLockServiceInfo, String> {
    ...
    /**
     * Properties of entity GatewayLockServiceInfo.<br/>
    ...
    public GatewayLockServiceInfoDao(DaoConfig config) {
        super(config);
    }
    
    public GatewayLockServiceInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GATEWAY_LOCK_SERVICE_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GATEWAY_LOCK_SERVICE_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GatewayLockServiceInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GatewayLockServiceInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public GatewayLockServiceInfo readEntity(Cursor cursor, int offset) {
        GatewayLockServiceInfo entity = new GatewayLockServiceInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, GatewayLockServiceInfo entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(GatewayLockServiceInfo entity, long rowId) {
        return entity.getDeviceIdUid();
    }
    
    @Override
    public String getKey(GatewayLockServiceInfo entity) {
        if(entity != null) {
            return entity.getDeviceIdUid();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GatewayLockServiceInfo entity) {
