...
public class SettingFaceWanderingAlarm {
    /**
     * {
     *         "msgtype": "request",
     *             "msgId":4,
    ...
    public SettingFaceWanderingAlarm(String msgtype, int msgId, String userId, String wfId, String func, ParamsBean params, String timestamp) {
