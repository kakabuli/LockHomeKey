 ...
 * Describe
 */
public abstract class LoginObserver<T> implements Observer<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        LogUtils.e("shulan 请求的数据是  code " + result.getCode() +"   " +result.isSuccess() +"    " +("200".equals(result.getCode())));
        if (result.isSuccess()) { //如果请求成功
            ...
            }else if("101".equals(result.getCode() + "")){
                onAckErrorCode(t);
            }else{
                onAckErrorCode(t);
            }
    ...
    public abstract void onAckErrorCode(T t);
