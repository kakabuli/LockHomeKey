...
public class SettingVideoLockPirResult implements Serializable {
    ...
    public SettingVideoLockPirResult(String msgtype, int msgId, String userId, String wfId, String func, ParamsBean params, String timestamp, int code) {
