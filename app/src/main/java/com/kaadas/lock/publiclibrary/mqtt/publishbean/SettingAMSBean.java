...
public class SettingAMSBean implements Serializable {
    ...
    public SettingAMSBean(String msgtype, int msgId, String userId, String wfId, String func, ParamsBean params, String timestamp, int code) {
