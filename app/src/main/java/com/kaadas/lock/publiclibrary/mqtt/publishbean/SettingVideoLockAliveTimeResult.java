...
public class SettingVideoLockAliveTimeResult implements Serializable {
    ...
    public SettingVideoLockAliveTimeResult(String msgtype, int msgId, String userId, String wfId, String func, ParamsBean params, String timestamp, int code) {
