...
public class SettingVoiceQualityResult {
    /**
     * {
     *         "msgtype": "request",
     *             "msgId":4,
    ...
    public SettingVoiceQualityResult(String msgtype, int msgId, String userId, String wfId, String func, ParamsBean params, String timestamp) {
