package com.kaadas.lock.publiclibrary.linphone.linphonenew.compatibility;
...
public class ApiTwentyOnePlus {
	...
	public static Notification createMessageNotification(Context context,
		...
		if (msgCount == 1) {
			...
			title ="unread_messages".replace("%i", String.valueOf(msgCount));
		}
		...
		Notification notif = new Notification.Builder(context)
			...
			.setLights(ContextCompat.getColor(context, R.color.colorA),
	...
	public static Notification createMissedCallNotification(Context context, String title, String text, PendingIntent intent) {
		...
		.setContentTitle(title)
		.setContentText(text)
		.setSmallIcon(R.mipmap.history_missed_selected)
		.setAutoCancel(true)
		.setContentIntent(intent)
		.setDefaults(Notification.DEFAULT_SOUND
				| Notification.DEFAULT_VIBRATE)
