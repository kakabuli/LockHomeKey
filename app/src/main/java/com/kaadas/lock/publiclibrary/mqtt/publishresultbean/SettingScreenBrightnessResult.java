...
public class SettingScreenBrightnessResult implements Serializable {
    ...
    public SettingScreenBrightnessResult(String msgtype, int msgId, String userId, String wfId, String func, ParamsBean params, String timestamp, int code) {
    ...
    @Override
    public String toString() {
        return "SettingScreenBrightnessResult{" +
                "msgtype='" + msgtype + '\'' +
                ", userId='" + userId + '\'' +
                ", msgId=" + msgId +
                ", wfId='" + wfId + '\'' +
