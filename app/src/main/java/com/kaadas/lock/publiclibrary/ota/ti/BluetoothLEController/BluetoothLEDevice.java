package com.kaadas.lock.publiclibrary.ota.ti.BluetoothLEController;
...
public class BluetoothLEDevice {
    ...
    public int writeCharacteristicAsync(BluetoothGattCharacteristic characteristic, byte[] val) {
        Log.e(TAG, "发送数据    " + Rsa.bytesToHexString(val));
    ...
    public int writeCharacteristicAsync(BluetoothGattCharacteristic characteristic, byte val) {
        Log.e(TAG, "发送数据    " + Rsa.bytesToHexString(new byte[]{val}));
    ...
    BluetoothGattCallback BluetoothLEDeviceCB = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothGatt.STATE_CONNECTED) {
                ...
                isConnected = false;
                isDiscovered = false;
                Log.e(TAG,"Device   断开连接 " + gatt.getDevice().getAddress().toString() + " DISCONNECTED");
                if (shouldReconnect) {
                    connectDevice();
                    isConnected = false;
                }
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            Log.e(TAG,"写数据   onCharacteristicWrite: Wrote to " + characteristic.getUuid().toString());
            if (myCB != null) {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            Log.e(TAG, "收到数据   " + Rsa.bytesToHexString(characteristic.getValue()) +"    UUID " + characteristic.getUuid().toString());
            if (myCB != null) {
        ...
        public void onMtuChanged(BluetoothGatt gatt, int mtu, int status) {
            Log.e(TAG," 设置mtu   onMtuChanged: Got new MTU setting : MTU = " + mtu + "status = " + status);
    ...
    public boolean commitTransactionToBT(BluetoothLETransaction trans) {
        ...
        switch (trans.transactionType) {
            ...
            case ENABLE_NOTIFICATION_SYNC:
                ...
                BluetoothGattDescriptor clientConfigChar = trans.characteristic .getDescriptor(UUID.fromString("00002902-0000-1000-8000-00805f9b34fb"));
            ...
            case WRITE_ASYNC:
            case WRITE_SYNC:
                Log.e(TAG, "写数据  " + Rsa.bytesToHexString(trans.dat));
