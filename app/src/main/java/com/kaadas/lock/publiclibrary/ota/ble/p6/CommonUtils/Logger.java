...
package com.kaadas.lock.publiclibrary.ota.ble.p6.CommonUtils;
...
public class Logger {
    ...
    public static void createDataLoggerFile(Context context) {
        mContext = context;
        try {
            mDataLoggerDirectory = new File(Environment.getExternalStorageDirectory() + File.separator + "");
