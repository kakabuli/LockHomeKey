...
public class FingerprintManagerAdapter extends BaseQuickAdapter<GetPasswordResult.DataBean.Fingerprint, BaseViewHolder> {


    public FingerprintManagerAdapter(@Nullable List<GetPasswordResult.DataBean.Fingerprint> data, int layoutId) {
        super(layoutId, data);
    }
