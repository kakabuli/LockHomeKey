...
public class BluetoothFunctionAdapater extends RecyclerView.Adapter {
   private List<BluetoothLockFunctionBean> data;
    private OnItemClickListener onItemClickListener;

    public BluetoothFunctionAdapater(List<BluetoothLockFunctionBean> data,OnItemClickListener onItemClickListener) {
        this.data = data;
