...
public class GatewayLockPasswrodTempararyFragment extends BaseFragment<GatewayLockPasswrodView, GatewayLockPasswordForeverPresenter<GatewayLockPasswrodView>> implements GatewayLockPasswrodView{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mView == null) {
            mView = inflater.inflate(R.layout.gateway_lock_fragment_password_temporary, container, false);
        }
    ...
    private void addLockPwd(String strForeverPassword) {
        if (addPwdIdList != null && addPwdIdList.size() > 0) {
            ...
            AlertDialogUtil.getInstance().singleButtonNoTitleDialog(getActivity(), getString(R.string.tempory_pwd_is_full), getString(R.string.hao_de), "#1F96F7", new AlertDialogUtil.ClickListener() {
                @Override
                public void left() {
