...
public class OtaMutiProgress extends View {
    ...
    public OtaMutiProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OtaMutiProgress(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setCurrNodeNO(int number, boolean isSuccess) {
        currNodeNO = number;
        currNodeState = isSuccess ? 1 : 0;
        invalidate();
        requestLayout();
    }
