...
public class WifiLockApPresenter extends BasePresenter<IWifiLockApView> {
...
//                        return;
//                    }
//                    WifiSetUpPresenter.WifiResult wifiResult = parseWifiData(adminPassword, tempData);
//                    if (wifiResult == null) {
//                        return;
//                    }
...
//    }
//
//    public WifiSetUpPresenter.WifiResult parseWifiData(String adminPassword, byte[] data) {
//        WifiSetUpPresenter.WifiResult wifiResult = new WifiSetUpPresenter.WifiResult();
...
//    }
    ...
    public void connectLockWifi(String homePassword, String homeSsid, String adminPasswrd, WifiUtils wifiUtils) {
        getWifiListDisposable = Observable.interval(0, 1, TimeUnit.SECONDS)//设置0延迟，每隔一秒发送一条数据
                .take(20)//设置截取前20次
                        ...
                        if (wifiList != null && wifiList.size() > 0) {
                            for (ScanResult scanResult : wifiList) {
                                ...
                                if (!TextUtils.isEmpty(sSsid)) {
                                    if (sSsid.startsWith("KDS")) {
                                        wifiUtils.connectWifiNoPws(sSsid);
                                        if (isSafe()){
