...
public class WifiVideoLockSetLanguagePresenter<T> extends BasePresenter<IWifiVideoLockSetLanguageView> {
    ...
    @Override
    public void attachView(IWifiVideoLockSetLanguageView view) {
