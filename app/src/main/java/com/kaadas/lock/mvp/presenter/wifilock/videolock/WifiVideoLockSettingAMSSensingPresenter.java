...
public class WifiVideoLockSettingAMSSensingPresenter<T> extends BasePresenter<IWifiVideoLockSettingAMSSensingView> {
    private Disposable settingAMSSenstingDisposable;
    ...
    public void settingAMSSensting(String wifiSN, int settingAMSSensting) {
        if (mqttService != null && mqttService.getMqttClient() != null && mqttService.getMqttClient().isConnected()) {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            ...
                            if(mSettingAMSResult != null && isSafe()){
                                if("200".equals(mSettingAMSResult.getCode() + "")){
                                    MyApplication.getInstance().getWifiLockInfoBySn(wifiSN).setBodySensor(settingAMSSensting);
            ...
            compositeDisposable.add(settingAMSSenstingDisposable);
        }
    }
