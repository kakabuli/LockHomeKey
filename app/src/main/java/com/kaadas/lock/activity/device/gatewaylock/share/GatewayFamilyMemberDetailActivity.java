...
import com.kaadas.lock.mvp.presenter.GatewayFamilyMemberDetailPresenter;
 ...
 * Created by David
 */
public class GatewayFamilyMemberDetailActivity extends BaseActivity<IGatewayFamilyMemberDeatilView, GatewayFamilyMemberDetailPresenter<IGatewayFamilyMemberDeatilView>> implements IGatewayFamilyMemberDeatilView, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gateway_family_member_detail);
    ...
    @Override
    protected GatewayFamilyMemberDetailPresenter<IGatewayFamilyMemberDeatilView> createPresent() {
        return new GatewayFamilyMemberDetailPresenter<>();
    }
