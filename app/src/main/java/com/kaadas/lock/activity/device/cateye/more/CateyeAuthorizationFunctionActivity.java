 ...
 */
public class CateyeAuthorizationFunctionActivity extends BaseActivity<ICatEyeFunctionView, CatEyeFunctionPresenter<ICatEyeFunctionView>> implements View.OnClickListener, ICatEyeFunctionView {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_look_back:
                ...
                if (gatewayInfo == null) {
                    Toast.makeText(CateyeAuthorizationFunctionActivity.this, getString(R.string.refresh_geteway), Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Intent intentVideo = new Intent(CateyeAuthorizationFunctionActivity.this, VideoCallBackActivity.class);
