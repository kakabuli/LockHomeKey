 ...
 * Created by David
 */
public class GatewayPasswordShareActivity extends BaseAddToApplicationActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gateway_password_share);
